      ...
      000003 02 00 6F         [24]  347 	ljmp	_main
                                    ...
                                    352 	.area CSEG    (CODE)
                                    353 ;------------------------------------------------------------
                                    354 ;Allocation info for local variables in function 'delay60ms'
                                    355 ;------------------------------------------------------------
                                    356 ;m                         Allocated to registers r7 
                                    357 ;n                         Allocated to registers r6 
                                    358 ;------------------------------------------------------------
                                    359 ;	.\src\main.c:11: void delay60ms(void)
                                    360 ;	-----------------------------------------
                                    361 ;	 function delay60ms
                                    362 ;	-----------------------------------------
      000062                        363 _delay60ms:
                           000007   364 	ar7 = 0x07
                           000006   365 	ar6 = 0x06
                           000005   366 	ar5 = 0x05
                           000004   367 	ar4 = 0x04
                           ...
                           000001   370 	ar1 = 0x01
                           000000   371 	ar0 = 0x00
                                    372 ;	.\src\main.c:17: for(m=0;m<100;m++)
      000062 7F 00            [12]  373 	mov	r7,#0x00
                                    374 ;	.\src\main.c:19: for(n=0;n<200;n++)
      000064                        375 00110$:
      000064 7E C8            [12]  376 	mov	r6,#0xc8
      000066                        377 00105$:
      000066 DE FE            [24]  378 	djnz	r6,00105$
                                    379 ;	.\src\main.c:17: for(m=0;m<100;m++)
      000068 0F               [12]  380 	inc	r7
      000069 BF 64 00         [24]  381 	cjne	r7,#0x64,00125$
      00006C                        382 00125$:
      00006C 40 F6            [24]  383 	jc	00110$
                                    384 ;	.\src\main.c:23: }
      00006E 22               [24]  385 	ret
                                    386 ;------------------------------------------------------------
                                    387 ;Allocation info for local variables in function 'main'
                                    388 ;------------------------------------------------------------
                                    389 ;	.\src\main.c:31: void main(void)
                                    390 ;	-----------------------------------------
                                    391 ;	 function main
                                    392 ;	-----------------------------------------
      00006F                        393 _main:
                                    394 ;	.\src\main.c:35: do
      00006F                        395 00101$:
                                    396 ;	.\src\main.c:39: P0=0xfe;      //第一个LED亮
      00006F 75 80 FE         [24]  397 	mov	_P0,#0xfe
                                    398 ;	.\src\main.c:41: delay60ms();
      000072 12 00 62         [24]  399 	lcall	_delay60ms
                                    400 ;	.\src\main.c:43: P0=0xfd;      //第二个LED亮
      000075 75 80 FD         [24]  401 	mov	_P0,#0xfd
                                    402 ;	.\src\main.c:45: delay60ms();
      000078 12 00 62         [24]  403 	lcall	_delay60ms
                                    404 ;	.\src\main.c:47: P0=0xfb;      //第三个LED亮
      00007B 75 80 FB         [24]  405 	mov	_P0,#0xfb
                                    406 ;	.\src\main.c:49: delay60ms();
      00007E 12 00 62         [24]  407 	lcall	_delay60ms
                                    408 ;	.\src\main.c:51: P0=0xf7;      //第四个LED亮
      000081 75 80 F7         [24]  409 	mov	_P0,#0xf7
                                    410 ;	.\src\main.c:53: delay60ms();
      000084 12 00 62         [24]  411 	lcall	_delay60ms
                                    412 ;	.\src\main.c:55: P0=0xef;      //第五个LED亮
      000087 75 80 EF         [24]  413 	mov	_P0,#0xef
                                    414 ;	.\src\main.c:57: delay60ms();
      00008A 12 00 62         [24]  415 	lcall	_delay60ms
                                    416 ;	.\src\main.c:59: P0=0xdf;      //第六个LED亮
      00008D 75 80 DF         [24]  417 	mov	_P0,#0xdf
                                    418 ;	.\src\main.c:61: delay60ms();
      000090 12 00 62         [24]  419 	lcall	_delay60ms
                                    420 ;	.\src\main.c:63: delay60ms();
      000093 12 00 62         [24]  421 	lcall	_delay60ms
                                    422 ;	.\src\main.c:65: P0=0xbf;      //第七个LED亮
      000096 75 80 BF         [24]  423 	mov	_P0,#0xbf
                                    424 ;	.\src\main.c:67: delay60ms();
      000099 12 00 62         [24]  425 	lcall	_delay60ms
                                    426 ;	.\src\main.c:69: P0=0x7f;      //第八个LED亮
      00009C 75 80 7F         [24]  427 	mov	_P0,#0x7f
                                    428 ;	.\src\main.c:71: delay60ms();
      00009F 12 00 62         [24]  429 	lcall	_delay60ms
                                    430 ;	.\src\main.c:73: }while(1);      //无限循环，使8位LED循环流水点亮
                                    431 ;	.\src\main.c:75: }
      0000A2 80 CB            [24]  432 	sjmp	00101$
                                    433 	.area CSEG    (CODE)
                                    434 	.area CONST   (CODE)
                                    435 	.area XINIT   (CODE)
